...
public class ListaAlumnos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Lista de alumnos");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jTextFieldMonto, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 270, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButtonAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAgregarActionPerformed
        ...
        lista.agregarFinal(nuevoAlumno);
        actualizarTextArea();
    ...
    private void jButtonEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEliminarActionPerformed
        String carnet = jTextFieldIngresarCarnet.getText();
        if (eliminarAlumnoPorCarnet(carnet)) {
    ...
    private void actualizarTextArea() {
        ...
        for (int i = 0; i < lista.tamano(); i++) {
            Alumno alumno = (Alumno) lista.obtener(i);
